...
![creating external storage](/img/simple-locker/creating-external-storage.png)

Now, we can install the malware on the VM.

![installing malware](/img/simple-locker/installing-malware.png)

![installed malware](/img/simple-locker/installed-malware.png)
...
![alien text](/img/simple-locker/alien-text.png)

Lets try removing the malware using adb.

![uninstalling malware](/img/simple-locker/uninstalling-malware.png)
...
![encrypted files](/img/simple-locker/encrypted-files.png)
...
![apk tool fails](/img/simple-locker/apk-tool-fails.png)
...
![start service](/img/simple-locker/startService.png)
...
![MainService](/img/simple-locker/MainService.png)
...
![encryption](/img/simple-locker/encryption.png)
...
![FilesEncryptor](/img/simple-locker/FileEncrypter.png)
...
![FilesEncryptorContructor](/img/simple-locker/FileEncrypterConstructor.png)
...
![encrypt function](/img/simple-locker/encrypt.png)
...
![decryption](/img/simple-locker/decryption.png)
...
![decrypter app](/img/simple-locker/decrypter.png)

yae yae ik. Im not a UI designer or an android developer. 

![files decrypted!!](/img/simple-locker/decryted.png)
